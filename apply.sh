...
sed -i 's#$GITHUB_API_URI#'"$GITHUB_API_URI"'#' $VP_THEME_HOME/config_updated.py
sed -i 's#$GITHUB_VOCAB_FOLDERS#'"$GITHUB_VOCAB_FOLDERS"'#' $VP_THEME_HOME/config_updated.py
